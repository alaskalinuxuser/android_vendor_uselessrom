...
ALARM_PATH := vendor/uselessrom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/uselessrom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/uselessrom/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/uselessrom/prebuilt/common/media/audio/ui
